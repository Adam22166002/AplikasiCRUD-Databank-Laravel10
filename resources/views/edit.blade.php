...
@section('title', 'Update Data bank')

@section('content')

<div class="container" >

    <h4 class="mb-3"> <center>Form - Update Data Bank</center></h4>    

    <form method="post" id="update" action="{{ route('data.update', $data->kode_bank) }}">
        @csrf
        ...
        @method('PUT')
            <div class="col">
                ...
                <div class="input-group mb-3">
                    ...
                    name="kode_bank" value="{{ $data->kode_bank }}">
                </div>
                ...
                <label for="nama_bank" class="fst-normal mb-3">Masukan Nama Bank :</label>
                                <div class="input-group mb-3">
                                    ...
                                    name="nama_bank" rows="10" value="{{ $data->nama_bank }}">
                                </div>
                                ...
                                @endif
                <label for="jenis_bank" class="fst-normal mb-3">Pilih Jenis Bank :</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text"><i class="bi bi-bank"></i></span>
                                    <select class="form-select @error('jenis_bank') is-invalid @enderror" name="jenis_bank" id="jenis_bank">
                                        <option disabled value="">Pilih Jenis Bank</option>
                                        <option value="{{ $data->jenis_bank }}">{{ $data->jenisBank->nama_jenis}}</option>
                ...
                <label for="alamat" class="fst-normal mb-3">Masukan Alamat :</label>
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" rows="100" value="{{ $data->alamat }}">
                        </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control @error('kota') is-invalid @enderror" name="kota" rows="20" value="{{ $data->kota }}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control @error('provinsi') is-invalid @enderror" name="provinsi" rows="20" value="{{ $data->provinsi }}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control @error('kode_pos') is-invalid @enderror" name="kode_pos" rows="5" value="{{ $data->kode_pos }}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control @error('nomer_telepon') is-invalid @enderror" name="nomer_telepon" rows="10" value="{{ $data->nomer_telepon }}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" rows="100" value="{{ $data->email }}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="textarea" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" value="{{ $data->deskripsi }}">
                </div>
